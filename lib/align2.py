...
def align_pe_segments(fastq_files, output_sam_file, segments,
    ...
    args = [sys.executable, py_script, seg_starts_str, seg_ends_str, fastq_files[0], fastq_files[1]]
...
def align(fastq_files, fastq_format, bowtie_index, output_sam_file,  
          bowtie_bin="bowtie",
          num_processors=2,
          segment_length=25, 
          trim5=0, 
    ...
    # TODO: check to see whether PE reads have \1 and \2 appended at end to
    ...
    align_pe_segments(fastq_files, output_sam_file, segments,
