...
def align_segment(fastq_file, output_sam_file, segment_start, segment_end,
    ...
    py_script = os.path.join(os.path.dirname(__file__), "spanning_segment_reads.py")
...
def main():
    ...
    segmented_aligner(options.output_file, options.fasta_file, options.fastq_format,
